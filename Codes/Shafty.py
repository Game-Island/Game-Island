...
icon=pygame.image.load("Shafty.png")
GD=pygame.display.set_mode((w,h))
pygame.display.set_caption("Shafty")
...
board= pygame.image.load("board_s.png")
...
menubg=pygame.image.load("menu_.png")
p=pygame.image.load("boardbg_.png")
...
pygame.mixer.music.load("shafty_audio.mp3")
pygame.mixer.music.set_volume(0.2)
snakesound=pygame.mixer.Sound("ladder.wav")
...
#Ladder check
def ladders(x):
    if x==2: return randint(20,35)
    elif x==9:return randint(30,60)
    elif x==45:return randint(30,80)
    elif x==71:return randint(40,90)
    else:return x

#Snake Check
def snakes(x): 
    if x==19:return randint(2,60)
    elif x==63:return randint(10,50)
    elif x==36:return randint(10,70)
    elif x==98:return randint(1,20)
    elif x==72:return randint(50,60)
    elif x==93:return randint(30,70)
    else:return x
...
def turn(score,l,s):
    ...
    if score<=100:
        ...
        while pygame.time.get_ticks()-time<1500:
            message_display1("Can't move!",650,50,35,white)
            pygame.display.update()
...
def play(b):
    ...
    while True:
                ...
                if t==1:
                    ...
                    if p1score==100:
                        ...
                        while pygame.time.get_ticks()-time<2000:
                            message_display1("Player 1 Wins",650,50,50,white)
            ...
            if button1("Player 2",mouse[0],mouse[1],400,700,200,50,yellow,grey,30):
                if t==2:
                    ...
                    if p2score==100:
                        time=pygame.time.get_ticks()
                        while pygame.time.get_ticks()-time<2000:
                            message_display1("Player 2 Wins",650,50,50,white)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 3",mouse[0],mouse[1],700,700,200,50,green,grey,30):
                if t==3:
                    ...
                    if p3score==100:
                        time=pygame.time.get_ticks()
                        while pygame.time.get_ticks()-time<2000:
                            message_display1("Player 3 Wins",650,50,50,white)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
            ...
            if button1("Player 4",mouse[0],mouse[1],1000,700,200,50,blue,grey,30):
                if t==4:
                    ...
                    if p4score==100:
                        time=pygame.time.get_ticks()
                        while pygame.time.get_ticks()-time<2000:
                            message_display1("Player 4 Wins",650,50,50,white)
                            pygame.mixer.Sound.play(win)
                            pygame.display.update()
                        break
        ...
        if l:
            time=pygame.time.get_ticks()
            while pygame.time.get_ticks()-time<2000:
                message_display1("There's a Shaft!",650,50,35,white)
                pygame.display.update()
        if s:
            time=pygame.time.get_ticks()
            while pygame.time.get_ticks()-time<2000:
